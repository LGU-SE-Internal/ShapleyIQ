...
│ dataset     ┆ algorithm ┆ total ┆ error ┆ runtime.sec ┆      MRR ┆ AC@1.count ┆ AC@3.count ┆ AC@5.count ┆     AC@1 ┆     AC@3 ┆     AC@5 ┆    Avg@3 ┆  Avg@5 │
│ ---         ┆ ---       ┆   --- ┆   --- ┆    onds:avg ┆      --- ┆        --- ┆        --- ┆        --- ┆      --- ┆      --- ┆      --- ┆      --- ┆    --- │
│ str         ┆ str       ┆   u32 ┆   u32 ┆         --- ┆      f64 ┆        f64 ┆        f64 ┆        f64 ┆      f64 ┆      f64 ┆      f64 ┆      f64 ┆    f64 │
│             ┆           ┆       ┆       ┆         f64 ┆          ┆            ┆            ┆            ┆          ┆          ┆          ┆          ┆        │
╞═════════════╪═══════════╪═══════╪═══════╪═════════════╪══════════╪════════════╪════════════╪════════════╪══════════╪══════════╪══════════╪══════════╪════════╡
│ rcabench_fi ┆ shapleyiq ┆  1124 ┆     0 ┆   17.395161 ┆ 0.494786 ┆      412.0 ┆      581.0 ┆      724.0 ┆ 0.366548 ┆ 0.516904 ┆ 0.644128 ┆ 0.443654 ┆ 0.5121 │
│ ltered      ┆           ┆       ┆       ┆             ┆          ┆            ┆            ┆            ┆          ┆          ┆          ┆          ┆        │